...
[![My Skills](https://skillicons.dev/icons?i=nuxtjs,vue,ts,js,vite,webpack,sass,git,figma,html,css,github,vscode,linux,supabase,bash,express,gulp,jest,jquery,md,nodejs,pug,react)](https://skillicons.dev)
