...
[![My Skills](https://skillicons.dev/icons?i=nuxtjs,vue,ts,js,vite,webpack,gulp,sass,git,figma,html,css,github,vscode,react,jest,express,nodejs,md,bash,linux,supabase,jquery,pug)](https://skillicons.dev)
